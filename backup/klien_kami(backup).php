...
// Ambil data klien
$queryKlien = mysqli_query($con, "SELECT * FROM tblklien ORDER BY id DESC");
$totalKlien = mysqli_num_rows($queryKlien);
?>
...
<body>
  ...
  <div class="wrapper">
            ...
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav__item has-dropdown">
                <a
                  href="#"
                  data-toggle="dropdown"
                  class="dropdown-toggle nav__item-link active">Mitra &amp; Pelatihan</a>
                <ul class="dropdown-menu">
                  <li class="nav__item">
                    <a href="klien_kami" class="nav__item-link active">Klien Kami</a>
                  </li>
                  <!-- /.nav-item -->
                  <li class="nav__item">
    ...
    <?php if ($totalKlien > 0) { ?>
      <section class="konig-mitra">
        <h1 class="konig-mitra-title text-center">KLIEN KAMI</h1>

        <div class="konig-mitra-grid">

          <?php while ($row = mysqli_fetch_assoc($queryKlien)) { ?>
            <figure class="konig-mitra-item">
              <img
                src="admin/assets/images/klien/<?php echo htmlentities($row['gambar']); ?>"
                alt="<?php echo htmlentities($row['judul']); ?>" />
              <figcaption class="konig-mitra-desc">
                <span><?php echo htmlentities($row['judul']); ?></span>
