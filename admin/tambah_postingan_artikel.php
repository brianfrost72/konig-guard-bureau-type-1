...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            if ($query) {
                $msg = "Postingan berhasil ditambahkan";
            } else {
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Tambah Postingan | KONIG KONTEN</title>
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>Detail Postingan</b></h4>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>Fitur Gambar (Ukuran 840x562px)</b></h4>
                                            ...
                                            <button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Simpan dan Posting</button>
