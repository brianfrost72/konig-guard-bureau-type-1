...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            $msg = "Kategori Artikel berhasil diperbarui.";
        } else {
...
?>
    ...
    <head>
        ...
        <title>Edit Kategori Artikel | KONIG KONTEN</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Edit Kategori Artikel</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Kategori Artikel </b></h4>
                                    <hr />
