...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Edit Postingan | KONIG KONTEN</title>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Gambar Postingan</b></h4>
<img src="postimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
<a href="ganti_gambar?pid=<?php echo htmlentities($row['postid']);?>">Update Gambar</a>
</div>
</div>
</div>
