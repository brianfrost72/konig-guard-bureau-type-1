...
<head>
    ...
    <title>Peluang Karier - KONIG GUARD BUREAU</title>
...
<body>
    ...
    =========================== -->
        <section
            ...
            <div class="bg-img">
                <img src="assets/images/page-titles/loker.jpg" alt="background" />
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="pagetitle__heading mb-0">Peluang Karir</h1>
                    </div>
                    <!-- /.col-12 -->
                </div>
                <!-- /.row -->
...
========================= -->
    ...
    =========================  -->
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
          ...
          > -->
        <!-- job item #1 -->
        <!-- <div class="gallery-img bounce-in">
